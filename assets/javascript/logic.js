...
$(document).ready(function () {
    ...
    $("#loginRedir").on("click", function () {
        $("#content").attr("style", "display:none;")
        $("#logbox").attr("style", "display:block;")
    })
    ...
    btnLogin.addEventListener("click", e => {
        ...
        $("#logbox").attr("style", "display:none;")
        $("#search-bar").attr("style", "display: block;")
        $("#rng").attr("style", "display: block;")
        ...
        $.ajax({
            ...
            for (i = 0; i < Math.min(10, response.meals.length); i++) {
                ...
                $("[ifav=" + istr + "]").on("click", function (event) {
                    ...
                    // var recRef = ref.key;
                    // console out an item from the object

                    console.log(name);


                    // $ to create a <"li"> for the name
                    // var listName = $("<li>" + name + "</li>");
                    //    var recLink = $("<")
                    // Need to create the functions to add <li> and style
